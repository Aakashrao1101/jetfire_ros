...
# Parameters
wheelbase = 0.16       # Distance between the wheels
wheelradius = 0.05
TPR = 60               # "Ticks" per revolution / Counts per revolution (Encoder parameter)
left_ticks = 0
right_ticks = 0
last_left_ticks = 0
last_right_ticks = 0
...
left_ticks_sub = rospy.Subscriber("/lwheel_ticks", Int32, leftTicksCallback)
right_ticks_sub = rospy.Subscriber("/rwheel_ticks", Int32, rightTicksCallback)
